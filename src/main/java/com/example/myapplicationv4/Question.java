...
public class Question {
    ...
    public Question(int upperLimit){
        ...
        this.qustionPhrase = firstNumber + " + " + secondNumber + " = ";
    ...
    public String getQustionPhrase() {
        return qustionPhrase;
    }

    public void setQustionPhrase(String qustionPhrase) {
        this.qustionPhrase = qustionPhrase;
    }
}
